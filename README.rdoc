...
You will need a {Mailchimp}[http://www.benchmarkemail.com/API/Doc] account. Once you have your Mailchimp account set up, you will need your username and password to access the API.
